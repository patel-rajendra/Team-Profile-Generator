...
const renderEngineer = engineer => {
    let template = fs.readFileSync(path.resolve(templatesDir,"engineer.html"));
...
const renderIntern = intern => {
    let template = fs.readFileSync(path.resolve(templatesDir,"intern.html"));
...
const renderMain = html =>{
    let template = fs.readFileSync(path.resolve(templatesDir,"main.html"));
